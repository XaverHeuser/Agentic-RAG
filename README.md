...
- *ingest_path*
  - Crawls directories, [loads documents](https://reference.langchain.com/python/langchain-community/document_loaders) (PDFs, Word docs, Text) and segments text into optimized chunks using [RecursiveCharacterTextSplitter](https://reference.langchain.com/python/langchain-text-splitters/base/TextSplitter).
